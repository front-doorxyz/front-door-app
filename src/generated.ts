// Generated by @wagmi/cli@1.3.0 on 8/29/2023 at 9:37:46 PM
import {
  useContractRead,
...
export const recruitmentABI = [
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'email', internalType: 'string', type: 'string', indexed: true },
      {
        name: 'refferer',
        internalType: 'address',
        type: 'address',
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'isDibursed', internalType: 'bool', type: 'bool' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'refereeMail', internalType: 'string', type: 'string' },
    ],
    name: 'registerReferral',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: 'email', internalType: 'string', type: 'string' }],
...
export const fndrFaucet2Address =
  '0xE7f1725e7734ce288f8367e1bb143e90bb3F0513' as const

export const fndrFaucet2Config = {
  address: fndrFaucet2Address,
  abi: fndrFaucet2ABI,
} as const
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fndrFaucetABI}__ and `functionName` set to `"getBalance"`.
 */
export function useFndrFaucetGetBalance<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link recruitmentABI}__ and `functionName` set to `"diburseBounty"`.
 */
export function useRecruitmentDiburseBounty<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'diburseBounty',
        TMode
      > & { functionName?: 'diburseBounty' }
    : UseContractWriteConfig<typeof recruitmentABI, 'diburseBounty', TMode> & {
        abi?: never
        functionName?: 'diburseBounty'
      } = {} as any,
) {
  return useContractWrite<typeof recruitmentABI, 'diburseBounty', TMode>({
    abi: recruitmentABI,
    address: recruitmentAddress,
    functionName: 'diburseBounty',
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link recruitmentABI}__ and `functionName` set to `"diburseBounty"`.
 */
export function usePrepareRecruitmentDiburseBounty(
  config: Omit<
    UsePrepareContractWriteConfig<typeof recruitmentABI, 'diburseBounty'>,
    'abi' | 'address' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'diburseBounty',
    ...config,
  } as UsePrepareContractWriteConfig<typeof recruitmentABI, 'diburseBounty'>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"maxTotalSupply"`.
 */
export function useFrontDoorTokenMaxTotalSupply<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"owner"`.
 */
export function useFrontDoorTokenOwner<
  TFunctionName extends 'owner',
  TSelectData = ReadContractResult<typeof frontDoorTokenABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useFrontDoorTokenRenounceOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof frontDoorTokenABI, 'renounceOwnership', TMode>(
    {
      abi: frontDoorTokenABI,
      address: frontDoorTokenAddress,
      functionName: 'renounceOwnership',
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function useFrontDoorTokenTransferOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof frontDoorTokenABI, 'transferOwnership', TMode>(
    {
      abi: frontDoorTokenABI,
      address: frontDoorTokenAddress,
      functionName: 'transferOwnership',
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareFrontDoorTokenRenounceOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof frontDoorTokenABI,
      'renounceOwnership'
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link frontDoorTokenABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function usePrepareFrontDoorTokenTransferOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof frontDoorTokenABI,
      'transferOwnership'
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link frontDoorTokenABI}__ and `eventName` set to `"OwnershipTransferred"`.
 */
export function useFrontDoorTokenOwnershipTransferredEvent(
  config: Omit<
    UseContractEventConfig<typeof frontDoorTokenABI, 'OwnershipTransferred'>,
    'abi' | 'address' | 'eventName'
  > = {} as any,
) {
  return useContractEvent({
    ...
    eventName: 'OwnershipTransferred',
    ...config,
  } as UseContractEventConfig<typeof frontDoorTokenABI, 'OwnershipTransferred'>)
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fndrFaucet2ABI}__.
 */
export function useFndrFaucet2Read<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof fndrFaucet2ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof fndrFaucet2ABI, TFunctionName, TSelectData>,
    'abi' | 'address'
  > = {} as any,
) {
  return useContractRead({
    ...
    address: fndrFaucet2Address,
    ...config,
  } as UseContractReadConfig<typeof fndrFaucet2ABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"FNDRAddress"`.
 */
export function useFndrFaucet2FndrAddress<
  TFunctionName extends 'FNDRAddress',
  TSelectData = ReadContractResult<typeof fndrFaucet2ABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"getBalance"`.
 */
export function useFndrFaucet2GetBalance<
  TFunctionName extends 'getBalance',
  TSelectData = ReadContractResult<typeof fndrFaucet2ABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"owner"`.
 */
export function useFndrFaucet2Owner<
  TFunctionName extends 'owner',
  TSelectData = ReadContractResult<typeof fndrFaucet2ABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__.
 */
export function useFndrFaucet2Write<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof fndrFaucet2ABI,
          string
        >['request']['abi'],
        TFunctionName,
        TMode
      >
    : UseContractWriteConfig<typeof fndrFaucet2ABI, TFunctionName, TMode> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<typeof fndrFaucet2ABI, TFunctionName, TMode>({
    abi: fndrFaucet2ABI,
    address: fndrFaucet2Address,
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function useFndrFaucet2RenounceOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof fndrFaucet2ABI, 'renounceOwnership', TMode>({
    abi: fndrFaucet2ABI,
    address: fndrFaucet2Address,
    functionName: 'renounceOwnership',
    ...config,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"requestTokens"`.
 */
export function useFndrFaucet2RequestTokens<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        TMode
      > & { functionName?: 'requestTokens' }
    : UseContractWriteConfig<typeof fndrFaucet2ABI, 'requestTokens', TMode> & {
        abi?: never
        functionName?: 'requestTokens'
      } = {} as any,
) {
  return useContractWrite<typeof fndrFaucet2ABI, 'requestTokens', TMode>({
    abi: fndrFaucet2ABI,
    address: fndrFaucet2Address,
    functionName: 'requestTokens',
    ...config,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function useFndrFaucet2TransferOwnership<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
  ...
  return useContractWrite<typeof fndrFaucet2ABI, 'transferOwnership', TMode>({
    abi: fndrFaucet2ABI,
    address: fndrFaucet2Address,
    functionName: 'transferOwnership',
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__.
 */
export function usePrepareFndrFaucet2Write<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, TFunctionName>,
    'abi' | 'address'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    address: fndrFaucet2Address,
    ...config,
  } as UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, TFunctionName>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"renounceOwnership"`.
 */
export function usePrepareFndrFaucet2RenounceOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, 'renounceOwnership'>,
    'abi' | 'address' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"requestTokens"`.
 */
export function usePrepareFndrFaucet2RequestTokens(
  config: Omit<
    UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, 'requestTokens'>,
    'abi' | 'address' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'requestTokens',
    ...config,
  } as UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, 'requestTokens'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `functionName` set to `"transferOwnership"`.
 */
export function usePrepareFndrFaucet2TransferOwnership(
  config: Omit<
    UsePrepareContractWriteConfig<typeof fndrFaucet2ABI, 'transferOwnership'>,
    'abi' | 'address' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link fndrFaucet2ABI}__.
 */
export function useFndrFaucet2Event<TEventName extends string>(
  config: Omit<
    UseContractEventConfig<typeof fndrFaucet2ABI, TEventName>,
    'abi' | 'address'
  > = {} as any,
) {
  return useContractEvent({
    ...
    address: fndrFaucet2Address,
    ...config,
  } as UseContractEventConfig<typeof fndrFaucet2ABI, TEventName>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `eventName` set to `"OwnershipTransferred"`.
 */
export function useFndrFaucet2OwnershipTransferredEvent(
  config: Omit<
    UseContractEventConfig<typeof fndrFaucet2ABI, 'OwnershipTransferred'>,
    'abi' | 'address' | 'eventName'
  > = {} as any,
) {
  return useContractEvent({
    ...
    eventName: 'OwnershipTransferred',
    ...config,
  } as UseContractEventConfig<typeof fndrFaucet2ABI, 'OwnershipTransferred'>)
}

/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link fndrFaucet2ABI}__ and `eventName` set to `"TokensTransfered"`.
 */
export function useFndrFaucet2TokensTransferedEvent(
  config: Omit<
    UseContractEventConfig<typeof fndrFaucet2ABI, 'TokensTransfered'>,
    'abi' | 'address' | 'eventName'
  > = {} as any,
) {
  return useContractEvent({
    ...
    eventName: 'TokensTransfered',
    ...config,
  } as UseContractEventConfig<typeof fndrFaucet2ABI, 'TokensTransfered'>)
}
